...
function getErrorConfig(errorType: ErrorDisplayProps['errorType'], t: (key: string) => string) {
  switch (errorType) {
    case 'network':
      return {
        icon: (
        ...
        defaultTitle: t('types.network'),
        defaultMessage: t('messages.network'),
      };
    case 'server':
      return {
        icon: (
        ...
        defaultTitle: t('types.server'),
        defaultMessage: t('messages.server'),
      };
    case 'data':
      return {
        icon: (
        ...
        defaultTitle: t('types.data'),
        defaultMessage: t('messages.data'),
      };
    default:
      return {
        icon: (
        ...
        defaultTitle: t('types.general'),
        defaultMessage: t('messages.general'),
      };
  }
}
...
export function ErrorDisplay({
  ...
  const defaultRetryText = retryText || t('common:buttons.reconnect');
